...
public abstract class KeyboardHandlerMixin {
    ...
    /**
     * Redirects the {@link net.minecraft.world.entity.Entity#hasPermissions(int) hasPermissions} call in F3+N behavior
     * to check whether the {@code gamemode} command is available instead.
     */
    ...
    private boolean redirectF3NHasPermission(LocalPlayer player, int level) {
        ...
        RootCommandNode<SharedSuggestionProvider> root = connection.getCommands().getRoot();
        return root.getChild("gamemode") != null;
    }

    /**
     * Redirects the {@link net.minecraft.world.entity.Entity#hasPermissions(int) hasPermissions} call in the game mode
     * switcher's behavior to check whether the {@code gamemode} command is available instead.
     */
